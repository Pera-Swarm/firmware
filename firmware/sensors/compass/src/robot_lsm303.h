...
public:
    ...
    SW_LSM303(SW_LSM303::vector<int16_t> v_min, SW_LSM303::vector<int16_t> v_max);
    ...
    float heading(bool avoidBurstRead = true);
...
*/
template <typename T> float SW_LSM303::heading(vector<T> from){
...
template <typename Ta, typename Tb, typename To> void SW_LSM303::vector_cross(const vector<Ta> *a, const vector<Tb> *b, vector<To> *out){
    out->x = (a->y * b->z) - (a->z * b->y);
    out->y = (a->z * b->x) - (a->x * b->z);
    out->z = (a->x * b->y) - (a->y * b->x);
}

template <typename Ta, typename Tb> float SW_LSM303::vector_dot(const vector<Ta> *a, const vector<Tb> *b){
