...
/**
* @brief    Arduino library for Pololu LSM303
* @author   www.pololu.com
* @version  3.0.1
...
SW_LSM303::SW_LSM303(SW_LSM303::vector<int16_t> v_min, SW_LSM303::vector<int16_t> v_max){
    m_min = v_min; // (SW_LSM303::vector<int16_t>){-32767, -32767, -32767};
    m_max = v_max; // (SW_LSM303::vector<int16_t>){+32767, +32767, +32767};
    _device = device_auto;
...
//------------------------------------------------------------------------------
#if defined(ENABLE_COMPASS_SENSOR)
//------------------------------------------------------------------------------

void SW_LSM303::begin(){
    Wire.begin();
    this->init();
    this->enableDefault();
...
unsigned int SW_LSM303::getTimeout(){
    return io_timeout;
}

bool SW_LSM303::init(deviceType device, sa0State sa0){
    // perform auto-detection unless device type and SA0 state were both specified
    if (device == device_auto || sa0 == sa0_auto)
    {
        // check for SW_LSM303D if device is unidentified or was specified to be this type
        ...
        // check for SW_LSM303DLHC, DLM, DLH if device is still unidentified or was specified to be one of these types
...
*/
void SW_LSM303::enableDefault(void){
...
void SW_LSM303::writeAccReg(byte reg, byte value){
...
byte SW_LSM303::readAccReg(byte reg){
    byte value;
...
void SW_LSM303::writeMagReg(byte reg, byte value){
...
byte SW_LSM303::readMagReg(int reg){
    byte value;
...
void SW_LSM303::writeReg(byte reg, byte value){
...
byte SW_LSM303::readReg(int reg){
...
void SW_LSM303::readAcc(void){
    ...
    // (12-bit resolution, right-aligned). The D has 16-bit resolution
...
// Reads all 6 channels of the SW_LSM303 and stores them in the object variables
void SW_LSM303::read(void){
    readAcc();
    readMag();
}
...
*/
float SW_LSM303::heading(bool avoidBurstRead){
...
int SW_LSM303::headingInt(bool avoidBurstRead){
    return (int)(this->heading(avoidBurstRead));
}
void SW_LSM303::vector_normalize(vector<float> *a){
...
int SW_LSM303::testReg(byte address, regAddr reg){
...
void SW_LSM303::enableDefault(void){}
void SW_LSM303::writeAccReg(byte reg, byte value){}
byte SW_LSM303::readAccReg(byte reg){ return 0;}
void SW_LSM303::writeMagReg(byte reg, byte value){}
byte SW_LSM303::readMagReg(int reg){ return 0;}


void SW_LSM303::writeReg(byte reg, byte value){}
byte SW_LSM303::readReg(int reg){ return 0;}

void SW_LSM303::readAcc(void){}
void SW_LSM303::readMag(void){}
void SW_LSM303::read(void){}

float SW_LSM303::heading(bool avoidBurstRead){ return 0.0;}
int SW_LSM303::headingInt(bool avoidBurstRead){ return 0;}
void SW_LSM303::vector_normalize(vector<float> *a){}

int SW_LSM303::testReg(byte address, regAddr reg){ return 0;}
void SW_LSM303::test(){}
